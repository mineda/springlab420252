...
import br.gov.sp.fatec.springlab420252.service.RevisaoService;
...
public class RevisaoController {
    ...
    public ResponseEntity<List<Revisao>> buscarPorTituloSecaoEDataHora(@RequestParam("titulo") String titulo, @RequestParam("dataHora") LocalDateTime dataHora) {
        return new ResponseEntity<List<Revisao>>(service.buscarPorTituloSecaoEDataHora(titulo, dataHora), HttpStatus.OK);
    }
